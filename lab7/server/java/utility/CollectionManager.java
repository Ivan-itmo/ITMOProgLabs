...
public class CollectionManager implements CollectionManagerInterface {
     ...
     */
    public CollectionManager(DBManager dbManager, String token) {
     ...
     */
    public void addLabWork(LabWork labWork, String login) {
        synchronized (collectionLabWork) {
            int flag = 0;
            ...
            if (flag == 1) {
                ...
                collectionLabWorkLogin.put(labWork, login);
     ...
     */
    public void updateLabWork(int id, LabWork updatedLabWork, String login) {
        synchronized (collectionLabWork) {
            LabWork targetLabWork = null;
            for (LabWork labWork : collectionLabWork) {
                if (labWork.getId() == id && Objects.equals(collectionLabWorkLogin.get(labWork), login)) {
     ...
     */
    public void removeByIdLabWork(int id, String login) {
        synchronized (collectionLabWork) {
     ...
     */
    public void removeAnyByDifficultyLabWork(Difficulty difficulty, String login) {
        synchronized (collectionLabWork) {
            Iterator<LabWork> iterator = collectionLabWork.iterator();
            while (iterator.hasNext()) {
                LabWork labWork = iterator.next();
                if (labWork.getDifficulty() == difficulty &&
                        Objects.equals(collectionLabWorkLogin.get(labWork), login)) {
    ...
    public void clearLabWork(String login) {
        synchronized (collectionLabWork) {
            ...
            for (LabWork labWork : collectionLabWork) {
                if (Objects.equals(collectionLabWorkLogin.get(labWork), login)) {
