...
public class AddIfMin extends Command {
     ...
     */
    public AddIfMin(CollectionManager collectionManager, CommandManager commandManager, String command, List<Object> args, ServerCommand serverCommand, String login) {
    ...
    public List<Object> execute() {
        try {
            ...
            if (minLabWork.compareTo(collectionManager.getMinElement()) < 0) {
                collectionManager.addLabWork(minLabWork, login);
            }
