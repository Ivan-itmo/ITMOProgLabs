 ...
 */
public class AskerValidatorArgs implements AskerValidatorInterface {
    ConsoleManager consoleManager;

    /**
     * Конструктор для создания объекта {@link AskerValidatorArgs}.
     *
     * @param consoleManager Менеджер консоли, используемый для ввода данных.
     */
    public AskerValidatorArgs(ConsoleManager consoleManager) {
    ...
    public int askUpdateId(String command) {
        ...
        while (true) {
            ...
            try {
                String input = consoleManager.inputArgs(command).trim();
                if (!input.matches("^-?\\d+$")) {
    ...
    public String askName(String command) {
        ...
        while (true) {
            ...
            name = consoleManager.inputArgs(command).trim();
            if (name.isEmpty()) {
    ...
    public String askpeopleName(String command) {
        ...
        while (true) {
            ...
            peoplename = consoleManager.inputArgs(command).trim();
    ...
    public Color askEyeColor(String command) {
        ...
        while (true) {
            ...
            try {
                eyeColor = Color.valueOf(consoleManager.inputArgs(command).trim().toUpperCase());
                break;
            } catch (IllegalArgumentException e) {
