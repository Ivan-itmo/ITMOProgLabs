...
public class SumOfMinimalPoint extends Command {
     ...
     */
    public SumOfMinimalPoint(CollectionManager collectionManager, CommandManager commandManager, String command, List<Object> args, ServerCommand serverCommand) {
