...
public class History extends Command {
     ...
     */
    public History(CollectionManager collectionManager, CommandManager commandManager, String command, List<Object> args, ServerCommand serverCommand, String login) {
    ...
    public List<Object> execute() {
        ...
        for (String cmd : commandManager.getQueue()) {
            list.add(cmd);
        }
        return list;
    }
