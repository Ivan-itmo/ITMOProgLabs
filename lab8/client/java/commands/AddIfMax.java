...
import asks.AskerValidatorArgsAddIfMax;
...
public class AddIfMax extends Command {
     ...
     */
    public AddIfMax(CommandManager commandManager, ConsoleManager consoleManager) {
    ...
    public LabWork execute() {
        AskerValidatorArgsAddIfMax asker = new AskerValidatorArgsAddIfMax(consoleManager);
            asker.ask();
